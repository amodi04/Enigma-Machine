...
class Enigma:
    def __init__(self, steckerbrett=None, settings_file=None, alpha=None, beta=None, gamma=None):
        ...
        elif alpha is not None and beta is not None and gamma is not None and steckerbrett is not None:
...
# Define enigma settings here when creating new instance.
enigma = Enigma(settings_file="settings.json")
message = input("Enter message:\n")
print("Encrypted Message: {}".format(enigma.encrypt_text(message)))

# TODO: Allow for symbols and numbers